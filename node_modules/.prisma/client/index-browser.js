...
exports.Prisma.MarketSurveyDetailCompScalarFieldEnum = makeEnum({
  id: 'id',
  composition: 'composition',
  marketSurveyDetailId: 'marketSurveyDetailId'
});

exports.Prisma.MarketSurveyDetailScalarFieldEnum = makeEnum({
  id: 'id',
  brand: 'brand',
  unit: 'unit',
  uomId: 'uomId',
...
exports.Prisma.MarketSurveyRequestScalarFieldEnum = makeEnum({
  id: 'id',
...
exports.Prisma.MarketSurveyScalarFieldEnum = makeEnum({
  id: 'id',
  numberDocument: 'numberDocument',
  pic: 'pic',
  date: 'date',
...
exports.Prisma.MasterBrandScalarFieldEnum = makeEnum({
  id: 'id',
...
exports.Prisma.MasterCompositionScalarFieldEnum = makeEnum({
  id: 'id',
  brandId: 'brandId',
...
exports.Prisma.MasterCountryScalarFieldEnum = makeEnum({
  id: 'id',
...
exports.Prisma.MasterDistributionPartnerScalarFieldEnum = makeEnum({
  id: 'id',
  nameDist: 'nameDist',
  isActive: 'isActive'
});

exports.Prisma.MasterDosageScalarFieldEnum = makeEnum({
  id: 'id',
  nameDossage: 'nameDossage',
  isActive: 'isActive'
});

exports.Prisma.MasterRoleScalarFieldEnum = makeEnum({
  id: 'id',
  roleName: 'roleName',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
...
exports.Prisma.MasterRoleUserScalarFieldEnum = makeEnum({
  id: 'id',
  userId: 'userId',
  nameRoleUser: 'nameRoleUser'
});

exports.Prisma.MasterSpecialityScalarFieldEnum = makeEnum({
  id: 'id',
  nameSpeciality: 'nameSpeciality',
  isActive: 'isActive'
});

exports.Prisma.MasterUmbrellaBrandScalarFieldEnum = makeEnum({
  id: 'id',
